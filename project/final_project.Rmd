...
Review: According to the story_stats, we can reject the null hypothesis because 0.02 < 0.05. There is no difference in the average earnings between men and women. 
...
# Run the model
two_way_ANOVA <- aov(earnings ~ occupation * sex, data = earning_data)
