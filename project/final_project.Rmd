...
New concept/Update: As I was researching more data and trying to incorproate race/ethnicity to the data, I found a decades worth of occupaitonal earning differences between men and women. It sparked a story idea of the earning difference between men and women in dominated fields. Website link: https://www.census.gov/data/tables/time-series/demo/industry-occupation/median-earnings.html? . I did use chatgpt to try to find sources with data that included men and women earnings, annually, for different race/ethnicities and in different occupations.  [find a way to add link or pdf link to chat convo]

The story is women are still earning less than men even in women dominated fields. Three women dominated fields are: General and operations managers, Elementary and middle school teachers, and Registered nurses. 

I randomly chose the women dominated fields from this website from the U.S. Department of Labor's Women Bureau: https://www.dol.gov/agencies/wb/data/occupations/most-common-occupations-women-labor-force. 

My null and alternative hypothesis remain the same: 
