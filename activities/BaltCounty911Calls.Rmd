...
- I would place a horizontal line at 20 and 3 calls. Everything above and below would be an outlier. 
- Pattern: I think the calls lower as we get colder in the months 
- 
...
- Considering anything beyond +/- 2 is unusual, it differs because I could have set the bar lower at line 18. But I was not too far off. I think I was on point for setting my lowest at 3. 3 is the biggest -2 and beyond marker, and everything lower is unsual.  
...
July 14 stands out with the highest overdose call for a Thursday with 23 calls. The average overdose call count for a Thursday is 10. 
...
- Why there is a dip in June and September. Could it revolve around school timing? I would firs want to research of significant events that occur in Baltimore, Maryland or Nationally during these months that could impact the call amount. I would reach out to a police call center to ask if they notice any patterns or know the answer. 
- Seasoning Depression and Overdose Calls. The colder months tend to be seen as a more depressed time of the year, but the overdose call count is higher during the warmer months. I would ask local mental experts (therapists, psychiatrist, University/School Counselors, etc). 
- 
