...
ANSWER HERE
- There are two distinct groups of outliers. One group is below the red line and one is above the red line, but both are 100% apart of the FARMS. The third "group" - said loosely because they're everywhere - is a big population of students who have a lesser FARMS percentage but variety of exceeded math expectation percentages. Some have a little under 25% and nearly a 100% of exceeded math expectation, while another student has a near 0% on FARMS percentage and  nearly 0% on exceeded math expectation. 
...
Looking at the adjusted R-squared, which is 0.02, and knowing the closer it is to 100, the more of the outcome the indepndent variable explains, I would say it doesn't explains a lot. In addition the p-value is 0.1, so there results are unlikely. 
...
CROOKED BILLET EL SCH has the math score of 95 and the abs_residual score of 30, meaning it is close to the expected score and it has a FARM percentage of 40%. 
...
Depending on the school the model does not support the statement, but for others it does. My story would revolve around the truths behind how FARM does not fully determine how well a school's math expectation will be. 
