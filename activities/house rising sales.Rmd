...
Property values have increased in a local neighborhood and local officials speculate the light rail train is the reason.

Recent home sales show a 6.8% increase in property value. The previous average was $285,000, and it is currently $304,500. 

Though the new rail train could be a contributing factor, there is no definitive answer that it is. Numerous reasons and causes to increasing property values. 
