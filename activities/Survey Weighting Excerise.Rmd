...
1. How does weighting affect our estimates of voting intentions? There is a chance weighting could be skewed if the respondent is a common voter or survey answerer, or if there is an underrepresented subgroup voting/answering the voting. 
2. Which demographic groups show the largest differences between weighted and unweighted results? Under-represented groups 

3. How might weighting influence reporting of this data? It will influence the predicted results of how many of each voter category voted or did not vote or were unsure and undecided. 
...
1 is a good normal singular response. Over 1 not enough responses and under 1 is is too many responses.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

0.23 means they are probably not that involved in voting. 3.04 could mean this is their first time voting.

3. Why might some respondents be weighted more heavily than others?
If this is their first time voting or there if there's underrepresentation of a subgroup, their results will be skewed. 
...
1. Which voter category shows the biggest difference between weighted and unweighted results?  -3.6 rarely/never voter category. 

2. How might these differences affect reporting on likely voter turnout? It can change a story's perspective if it is discovered the likelihood rarely/never voters are to now or continue not to vote.  

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? As mentioned above in why we use survey weighting, it provides a scale system and offers volume to the results so under-represented groups have more of a voice.
