...
### Task 3: Create totals of aces for each team using `group_by()` and `summarize()`. You can't do group_by without summarize
...
Maryland is in the 95th percentile, which means it is better than 95% of the other teams. 
