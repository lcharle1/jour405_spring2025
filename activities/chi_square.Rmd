...
- The observed data is different than the expected data. Some categories are lower and higher than the expected data. 
- 1 star was the closest to the expected, off by 2 movies. 
...
The chi-squre statistic is 9.95 and the critical value is 9.48. Since the chi-square stat is greater than the critical value, I would reject the null hypothesis because the observed frequencies are significantly different from the expected frequencies. 
