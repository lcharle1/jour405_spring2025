...
gdp_djia |>
  summarize( 
    correlation = cor(DJIA, GDP, method = "pearson")
    )
...
From the correlation result, 0.9, we know there is a high correlation between the two. From the scatter plot we can see when the Gross Domestric Product rises, so does the Dow Jones Industrial Average. In the lower numbers there is more of a concise increase between both, and the higher the number goes the more outliers we have but there is still a high correlation between the two. 
