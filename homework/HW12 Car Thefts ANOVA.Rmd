...
- The mean is highest for the spike year and lowest pre-spike year. Post-spike year is not significantly different than spike year but it is lower. 
- the sd_rate being 0 shows the resut is very close to the mean and less variations. 
- The mean and median rate is the same for all three years. 
- There is a higher record of rows for pre-spike than spike and post year combined. 
...
Title: Highlighted Spike Year of Car Thefts 

Lede: 2023 isjm  the spike year with the highest car theft rates, according to research analyzing monthly car thefts from 2017 to 2025. The study was looking to determine if theft rates differed significantly between pre-spike (before 2023), spike (2023), and post-spike (2024-present) periods. 
...
- **Null Hypothesis (H0)**: Theft rates do not differ significantly between pre-spike (before 2023), spike (2023), and post-spike (2024-present) periods.

- **Alternative Hypothesis (H1)**: Theft rates  differ significantly between pre-spike (before 2023), spike (2023), and post-spike (2024-present) periods.
...
Due to the low F-value, 0.18 the groups are pretty similar. This means the result is not significant and we accept the null hypothesis.
...
- Looking at the Tukey's test and chart, you can tell there are no significant differences - or any at all in the chart. 

Headline: PG County Car Theft Rate Begin to Decline Post Spike Year 

Prince George's County's car theft rate is declining since it's spike year, 2023. With an average of 573, research shows the rate is down to 418. It is statistically proven that the data is not significantly difference between the years. 
