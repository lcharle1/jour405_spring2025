...
Survey samples often misrepresent education levels because more educated individuals are likelier to respond, have better access to surveys, and are more often included in sampling frames, leading to over representation of higher education groups.
...
College Students Have The Highest Voting Intentions 
...
Overall, there weren't any significant changes, a few increases and decreases throughout the education levels. The biggest change was in highschool or less yes% where the difference is 2.7%, the percentage decreased after weighted. 
...
Weighted results is leveling the play field. Compared to unweighted results, weighted results fix imbalances and give more volume to underrepresented group and less to over represented groups. Without this, data could be skewed and unnecessary attention could be given to groups who are already well represented. Unweighted results also do not give light to subgroups in populations, whereas weighted results do. 
...
High school or less Yes % difference is the largest at -2.7%. 
...
Yes it does. It makes comparing the weighted and unweighted results simpler and easier to understand. Compared to going through all the steps we did before to find the accurate percentage differences and everything. It also shines a light on which group is over and under represented. 
...
College level respondents were more likely to say they planned to vote, while those with a high school education or less or some college were less likely to report the same. This suggests that education plays a significant role in voting intentions. 

The unweighted results are not significantly difference than the weighted results but there are differences especially in high school or less education level. Once the results were weighted, voting among the hs or less category dropped by 2.7%, the largest percent change in the chart. Weighting helped correct the over representation of more educated respondents, providing a more balanced and realistics views of likely voter turnout across education groups. 

This shows the importance of understanding how polling data is collected and adjusted. Reporting unweighted results can mislead audiences by amplifying the voices of over represented groups. Weighted results offer a clearer and accurate picture. 
...
It ensures they accurately interpret and communicate poll results. Without weighting, certain groups—like college-educated respondents—may be overrepresented, leading to misleading conclusions about public opinion. 

2. How might the differences between weighted and unweighted results affect how you would report on this data?

If unweighted data shows higher voter intention among certain groups—like college graduates—but those groups are overrepresented, it could exaggerate their influence. By using weighted results, you provide a more accurate picture of the electorate, which might shift the focus or tone of the reporting. 
...
- location of the high school, some college, and college. If this was all tested in the same state, county, or town.
- How much funding the institutions received
- Where did the institutions rank in terms of how well the education is there. 
